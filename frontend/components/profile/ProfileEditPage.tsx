...
export function ProfileEditPage() {
  ...
  const inputClass =
    "w-full rounded-xl border border-slate-700 bg-slate-900/50 px-3 py-2.5 text-sm text-slate-100 outline-none ring-blue-500/30 placeholder:text-slate-500 focus:border-blue-500 focus:ring-2 disabled:opacity-60";
  ...
  return (
    <InteractivePageShell className="bg-slate-900 text-slate-100">
      ...
      <header className="border-b border-slate-800 bg-slate-900/95 backdrop-blur">
        <div className="mx-auto flex h-16 w-full max-w-7xl items-center justify-between px-4">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-lg border border-slate-700 bg-slate-800 px-3 py-2 text-sm font-semibold text-slate-100 transition-colors hover:bg-slate-700 disabled:cursor-not-allowed disabled:opacity-50"
          >
      ...
      <div className="mx-auto w-full max-w-7xl px-4 py-6">
        {loadError ? (
          <p className="mb-4 rounded-lg bg-red-950/50 px-4 py-3 text-sm text-red-300">{loadError}</p>
        ) : null}
          ...
          <section className="min-w-0 space-y-5 lg:col-span-5">
            <div className="overflow-hidden rounded-2xl border border-slate-700 bg-slate-800">
              <button
                ...
                className="group relative block h-56 w-full border-b border-slate-700 text-left"
              >
                {coverPreview ? (
              ...
              <div className="relative border-t border-slate-700 p-4 pt-14">
                ...
                >
                  <div className="relative flex size-20 items-center justify-center overflow-hidden rounded-full border-4 border-slate-800 bg-slate-700 text-lg font-bold text-slate-100 shadow-xl">
                    {avatarPreview ? (
                      // eslint-disable-next-line @next/next/no-img-element
                      <img
                        src={avatarPreview}
      ...
      {toast ? (
        <div
          className="fixed bottom-24 left-1/2 z-50 flex -translate-x-1/2 items-center gap-2 rounded-xl border border-emerald-700/50 bg-slate-900 px-5 py-3 text-sm font-semibold text-emerald-300 shadow-lg md:bottom-8"
          role="status"
          aria-live="polite"
        >
  ...
  return (
    <div>
      ...
      <input
        ...
        disabled={disabled}
        className="w-full rounded-xl border border-slate-700 bg-slate-900/50 px-3 py-2.5 text-sm text-slate-100 outline-none ring-blue-500/30 placeholder:text-slate-500 focus:border-blue-500 focus:ring-2 disabled:cursor-not-allowed disabled:opacity-60"
      />
    </div>
  );
}
